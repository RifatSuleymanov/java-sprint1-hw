    ...
    public static void main(String[] args) {
        ...
        while (userInput != 0) {
            ...
            if (userInput == 1) {
                ...
                int steps = stepTracker.saveUserStepMonth(userMonth);
                ...
                System.out.println("Пройденная дистанция (в км) " + String.format("%.2f", converter.totalStepsPerMonths(steps)));
                System.out.println("Количество сожженных килокалорий: " + converter.convertKcal(steps));
